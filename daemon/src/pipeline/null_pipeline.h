...
class NullPipeline : public Pipeline {
 public:
  ...
  virtual void Configure(CaptureConfig const& config) final {}
  virtual void Configure(PipelineConfig const& config) final {}
  virtual void Configure(StreamConfig const& config) final {}
