...
std::string MinAreaTargetData::Dump() const {
  json j = json{{TargetData::kIdKey, id},
                ...
                {MinAreaTargetData::kBLX, corners[1].x},
                {MinAreaTargetData::kBLY, corners[1].y},
                {MinAreaTargetData::kTLX, corners[2].x},
                {MinAreaTargetData::kTLY, corners[2].y},
                {MinAreaTargetData::kTRX, corners[3].x},
                {MinAreaTargetData::kTRY, corners[3].y},
                {MinAreaTargetData::kBRX, corners[0].x},
                {MinAreaTargetData::kBRY, corners[0].y},
