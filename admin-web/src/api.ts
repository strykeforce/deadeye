...
export const configPipeline = (unit: string, inum: number, pipeline: PipelineConfig): void => {
  pipeline.sn++;
...
export const configStream = (unit: string, inum: number, stream: StreamConfig): void => {
  stream.sn++;
