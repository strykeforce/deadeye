 ...
 *
 * <p>Classes {@code UprightRectTargetData}, {@code MinAreaRectTargetData}, and {@code
 ...
 * DeadeyeJsonAdapter}.
 *
 * <p>Classes {@code Point} and {@code Point2D} are utility classes used by the {@code TargetData}
 * classes.
 */
